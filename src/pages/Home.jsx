      ...
      <section>
        <div className="relative">
          <div className="bg-[#C12529] text-white py-1 px-10">
            <p className="text-[13px]">Home / Mutual Finds</p>
          </div>
          <img
            src={HomeBanner}
            ...
            <div className="w-[622px] h-[195px] bg-white p-9">
              <div className="flex space-x-2">
                ...
                <div>
                  ...
                  <p>
                    The free portfolio tracker tool from Value Research - track
                    your stocks, mutual funds, NPS holdings and more.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-[622px] h-[195px] bg-[#D9D9D9] p-9">
              <div className="flex space-x-2">
                ...
                <div>
                  ...
                  <p>
                    Mutual funds are highly liquid investments, which means that
                    investors can easily buy and sell their units at any time.
                    Mutual funds are highly liquid investments, which means that
                    investors can easily buy and sell their units at any time.
                  </p>
                </div>
      ...
      <section>
        ...
        <div className="px-24 mt-28">
          <div>
            ...
            <p>
              When investing in mutual funds, there are two avenues or modes of
              investment - Systematic Investment Plans (SIP) and Lumpsum
            </p>
            <p className="mt-4">
              ...
              SIPs enable you to spread your investments over time, reducing the
              impact of market volatility. For example, you invest ₹10,000 every
              month to achieve an investment goal of ₹12,00,000 over 10 years.
            </p>
            <p className="mt-2">
          ...
          <div className="mt-10">
            ...
            <p className="mt-3">
              ...
              primarily based on their asset class. Here, we explore three main
              categories:
            </p>
            <p className="mt-6">
              Equity Mutual Funds Equity mutual funds primarily invest in stocks
              or shares of companies. These funds aim for capital appreciation
              and are well-suited for investors with a higher risk tolerance and
              a long-term investment horizon. Equity funds can be further
              categorised into various subtypes, such as large-cap, mid-cap, and
              small-cap funds, each focusing on companies of the respective
              market capitalisations. Equity mutual funds have the potential for
              significant returns but can also be relatively volatile.
            </p>
            <p>
              Debt Mutual Funds Debt mutual funds allocate their assets to
              fixed-income securities such as bonds, government securities, and
              corporate debentures. They are known for generating regular income
              through interest payments and are considered less risky than
              equity funds. Debt funds are a preferred choice for conservative
